<script lang="ts">
	...
	let thumb: HTMLElement | undefined = undefined;
	let progressBar: HTMLElement | undefined = undefined;
	let element: HTMLElement | undefined = undefined;

	// Internal State
	let elementX: number | undefined = undefined;
	let currentThumb: HTMLElement | undefined = undefined;
	let holding = false;
	...
	function isMouseInElement(event: MouseEvent, element: HTMLElement | undefined) {
	...
	function calculateNewValue(clientX: number) {
		...
		let percent = (delta * 100) / (container?.clientWidth ? container.clientWidth - 10 : 0);
